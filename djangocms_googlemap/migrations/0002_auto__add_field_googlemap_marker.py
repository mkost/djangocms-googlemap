...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GoogleMap.marker'
        db.add_column(u'djangocms_googlemap_googlemap', 'marker',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GoogleMap.marker'
        db.delete_column(u'djangocms_googlemap_googlemap', 'marker')
    ...
    models = {
        ...
        u'djangocms_googlemap.googlemap': {
            ...
            'marker': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
